...
namespace AutoMicroMapper.MicroMapper.UnitTests
{
    ...
    {
        public class When_configuring_a_member_to_skip_based_on_the_property_value : SpecBase
        {
            public class Source
            {
            ...
            {
                var destination = MicroMapper.MicroMapper.Map<Source, Destination>(new Source {Value = -1});
            ...
            {
                var destination = MicroMapper.MicroMapper.Map<Source, Destination>(new Source { Value = 7 });

                destination.Value.ShouldEqual(7);
            }
        }

        public class When_configuring_a_member_to_skip_based_on_the_property_metadata : SpecBase
        {
