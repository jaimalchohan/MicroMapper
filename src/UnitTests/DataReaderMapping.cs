...
namespace AutoMicroMapper.MicroMapper.UnitTests
{
    ...
    {
        public class When_mapping_a_data_reader_to_a_dto : SpecBase
        {
            protected override void Establish_context()
            {
                MicroMapper.MicroMapper.CreateMap<IDataReader, DTOObject>()
                    .ForMember(dest => dest.Else, options => options.MapFrom(src => src.GetDateTime(10)));

                _dataReader = new DataBuilder().BuildDataReader();
                _result = MicroMapper.MicroMapper.Map<IDataReader, IEnumerable<DTOObject>>(_dataReader).FirstOrDefault();
            }
        ...
        public class When_mapping_a_single_data_record_to_a_dto : SpecBase
        {
            protected override void Establish_context()
            {
                MicroMapper.MicroMapper.CreateMap<IDataRecord, DTOObject>()
                ...
                _result = MicroMapper.MicroMapper.Map<IDataRecord, DTOObject>(_dataRecord);
            }
        ...
        public class When_mapping_a_data_reader_to_a_dto_with_nullable_field : SpecBase
        {
            ...
            protected override void Establish_context()
            {
                MicroMapper.MicroMapper.CreateMap<IDataReader, DtoWithSingleNullableField>();
            ...
            public void Then_results_should_be_as_expected()
            {
                ...
                {
                    var dto = MicroMapper.MicroMapper.Map<IDataReader, DtoWithSingleNullableField>(_dataReader);
