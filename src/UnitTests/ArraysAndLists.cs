...
namespace AutoMicroMapper.MicroMapper.UnitTests
{
	...
	{
		public class When_mapping_to_a_concrete_non_generic_ienumerable : SpecBase
		{
			...
			{
				_destination = MicroMapper.MicroMapper.Map<Source, Destination>(new Source {Values = new[] {1, 2, 3, 4}, Values2 = new List<int> {9, 8, 7, 6}});
			}
		...
		public class When_mapping_to_a_concrete_generic_ienumerable : SpecBase
		{
			private Destination _destination;
		...
		public class When_mapping_to_a_concrete_non_generic_icollection : SpecBase
		{
			private Destination _destination;
		...
		public class When_mapping_to_a_concrete_generic_icollection : SpecBase
		{
			private Destination _destination;
			...
			protected override void Because_of()
			{
				_destination = MicroMapper.MicroMapper.Map<Source, Destination>(new Source {Values = new[] {1, 2, 3, 4}});
			}
		...
		public class When_mapping_to_a_concrete_ilist : SpecBase
		{
			private Destination _destination;
		...
		public class When_mapping_to_a_concrete_generic_ilist : SpecBase
		{
			private Destination _destination;
		...
		public class When_mapping_to_a_custom_list_with_the_same_type : SpecBase
		{
			private Destination _destination;
			...
			protected override void Because_of()
			{
				...
				_destination = MicroMapper.MicroMapper.Map<Source, Destination>(_source);
			}
        ...
        public class When_mapping_to_a_collection_with_instantiation_managed_by_the_destination : SpecBase
		{
			private Destination _destination;
			private Source _source;
			...
			protected override void Establish_context()
			{
			    ...
			    MicroMapper.MicroMapper.CreateMap<SourceItem, DestItem>();
			}
		...
		public class When_mapping_to_an_existing_list_with_existing_items : SpecBase
		{
			...
			protected override void Because_of()
			{
				...
				MicroMapper.MicroMapper.Map(_source, _destination);
			}
        ...
        public class When_mapping_a_collection_with_null_members : SpecBase
        {
            ...
            protected override void Establish_context()
            {
                MicroMapper.MicroMapper.Initialize(x => x.AllowNullDestinationValues = true);
            ...
            protected override void Because_of()
            {
                _mappedStrings = MicroMapper.MicroMapper.Map<IEnumerable<string>, List<string>>(_strings);
            }
		...
		public class When_destination_collection_is_only_a_list_source_and_not_IList : SpecBase
		{
			...
			protected override void Because_of()
			{
				_destination = MicroMapper.MicroMapper.Map<Source, Destination>(new Source {Values = new[] {1, 2, 3}});
			}
