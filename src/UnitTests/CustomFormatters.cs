...
namespace AutoMicroMapper.MicroMapper.UnitTests
{
	...
	{
		public class When_applying_global_formatting_rules : SpecBase
		{
			...
			{
				MicroMapper.MicroMapper.AddFormatter<HardEncoder>();
				MicroMapper.MicroMapper.AddFormatter(new SoftEncoder());
				MicroMapper.MicroMapper.AddFormatter(typeof(RokkenEncoder));
				MicroMapper.MicroMapper.AddFormatExpression(context => context.SourceValue + " Medium");

				MicroMapper.MicroMapper.CreateMap<ModelObject, ModelDto>();

				var modelObject = new ModelObject { Value = 14 };

				_modelDto = MicroMapper.MicroMapper.Map<ModelObject, ModelDto>(modelObject);
			}
		...
		public class When_applying_type_specific_global_formatting_rules : SpecBase
		{
			...
			protected override void Establish_context()
			{
			    ...
			    _intResult = MicroMapper.MicroMapper.Map<int, string>(44);
			}
		...
		public class When_applying_type_specific_and_general_global_formatting_rules : SpecBase
		{
			private ModelDto _result;
			...
			protected override void Establish_context()
			{
				MicroMapper.MicroMapper.AddFormatExpression(context => string.Format("{0} Value", context.SourceValue));
				MicroMapper.MicroMapper.ForSourceType<int>().AddFormatExpression(context => ((int)context.SourceValue + 1).ToString());
		...
		public class When_resetting_the_global_formatting : SpecBase
		{
			private ModelDto _modelDto;
			...
			protected override void Establish_context()
			{
				MicroMapper.MicroMapper.AddFormatter<CrazyEncoder>();
		...
		public class When_skipping_a_specific_property_formatting : SpecBase
		{
			private ModelDto _result;
			...
			protected override void Establish_context()
			{
				MicroMapper.MicroMapper.ForSourceType<int>().AddFormatter<SampleFormatter>();
		...
		public class When_skipping_a_specific_type_formatting : SpecBase
		{
			private ModelDto _result;
			...
			protected override void Establish_context()
			{
				MicroMapper.MicroMapper.AddFormatter<SampleFormatter>();
				MicroMapper.MicroMapper.ForSourceType<int>().SkipFormatter<SampleFormatter>();
		...
		public class When_configuring_formatting_for_a_specific_member : SpecBase
		{
			private ModelDto _result;
		...
		public class When_substituting_a_specific_value_for_nulls : SpecBase
		{
			private ModelDto _result;
		...
		public class When_using_a_custom_contruction_method_for_formatters : SpecBase
		{
			...
			protected override void Establish_context()
			{
				...
				MicroMapper.MicroMapper.AddFormatter<CustomFormatter>().ConstructedBy(() => new CustomFormatter(10));
				MicroMapper.MicroMapper.AddFormatter(typeof(OtherCustomFormatter)).ConstructedBy(() => new OtherCustomFormatter(" Splorg"));
			}

			protected override void Because_of()
			{
				var source = new Source { Value = 10};
				_result = MicroMapper.MicroMapper.Map<Source, Dest>(source);
			}
		...
		public class When_using_a_global_custom_construction_method_for_formatters : SpecBase
		{
			...
			protected override void Establish_context()
			{
				MicroMapper.MicroMapper.Initialize(cfg => cfg.ConstructServicesUsing(type => new SomeFormatter("ctor'd")));
