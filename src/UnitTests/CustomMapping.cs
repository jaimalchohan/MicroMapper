...
namespace AutoMicroMapper.MicroMapper.UnitTests
{
	...
	{
		public class When_mapping_to_a_dto_member_with_custom_mapping : SpecBase
		{
		...
		public class When_using_a_custom_resolver_for_a_child_model_property_instead_of_the_model : SpecBase
		{
			private ModelDto _result;
		...
		public class When_reseting_a_mapping_to_use_a_resolver_to_a_different_member : SpecBase
		{
			...
			protected override void Establish_context()
			{
				...
				_result = MicroMapper.MicroMapper.Map<Source, Dest>(model);
			}
		...
		public class When_reseting_a_mapping_from_a_property_to_a_method : SpecBase
		{
			private Dest _result;
		...
		public class When_specifying_a_custom_constructor_and_member_resolver : SpecBase
		{
		...
		public class When_specifying_a_member_resolver_and_custom_constructor : SpecBase
		{
			private Source _source;
			private Destination _dest;
		...
		public class When_specifying_a_custom_translator : SpecBase
		{
			private Source _source;
			private Destination _dest;
		...
		public class When_specifying_a_custom_translator_and_passing_in_the_destination_object : SpecBase
		{
			private Source _source;
			private Destination _dest;
			...
			public void Should_resolve_to_the_destination_object_from_the_custom_translator()
			{
				...
				_dest = MicroMapper.MicroMapper.Map(_source, _dest);
				_dest.Value.ShouldEqual(20);
			}
		...
		public class When_specifying_a_custom_translator_using_generics : SpecBase
		{
			private Source _source;
			private Destination _dest;
		...
		public class When_specifying_a_custom_constructor_function_for_custom_converters : SpecBase
		{
			...
			protected override void Establish_context()
			{
				MicroMapper.MicroMapper.Initialize(init => init.ConstructServicesUsing(t => new CustomConverter(10)));
				MicroMapper.MicroMapper.CreateMap<Source, Destination>()
		...
		public class When_specifying_a_custom_translator_with_mismatched_properties : SpecBase
		{
			public class Source
			{
		...
		public class When_configuring_a_global_constructor_function_for_resolvers : SpecBase
		{
			private Destination _result;
			...
			protected override void Establish_context()
			{
				MicroMapper.MicroMapper.Initialize(cfg => cfg.ConstructServicesUsing(type => new CustomValueResolver(5)));
		...
		public class When_specifying_member_and_member_resolver_using_string_property_names : SpecBase
		{
			private Destination _result;
			...
			protected override void Establish_context()
			{
				MicroMapper.MicroMapper.Initialize(cfg => cfg.ConstructServicesUsing(type => new CustomValueResolver()));
			...
			protected override void Because_of()
			{
				_result = MicroMapper.MicroMapper.Map<Source, Destination>(new Source { SourceValue = 5 });
			}
...
#endif
        public class When_destination_property_does_not_have_a_setter : SpecBase
        {
            private Source _source;
            private Destination _dest;
		...
		public class When_destination_type_requires_a_constructor : SpecBase
		{
		...
		public class When_mapping_from_a_constant_value : SpecBase
		{
			private Dest _dest;
