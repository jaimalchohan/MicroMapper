...
namespace AutoMicroMapper.MicroMapper.UnitTests
{
	...
	{
		public class When_mapping_to_a_non_generic_dictionary : SpecBase
		{
		...
		public class When_mapping_to_a_generic_dictionary_with_mapped_value_pairs : SpecBase
		{
			...
			{
				MicroMapper.MicroMapper.CreateMap<Source, Destination>();
				MicroMapper.MicroMapper.CreateMap<SourceValue, DestinationValue>();
			}
		...
		public class When_mapping_from_a_source_with_a_null_dictionary_member : SpecBase
		{
			...
			protected override void Establish_context()
			{
				...
				MicroMapper.MicroMapper.CreateMap<Foo, FooDto>();
				MicroMapper.MicroMapper.CreateMap<FooDto, Foo>();
			}
			...
			protected override void Because_of()
			{
				...
				_result = MicroMapper.MicroMapper.Map<Foo, FooDto>(foo1);
			}
		...
		public class When_mapping_to_a_generic_dictionary_that_does_not_use_keyvaluepairs : SpecBase
		{
			...
			protected override void Establish_context()
			{
				MicroMapper.MicroMapper.CreateMap<SourceDto, DestDto>()
			...
			protected override void Because_of()
			{
				...
				_dest = MicroMapper.MicroMapper.Map<IDictionary<string, string>, IDictionary<string, string>>(source.Items);
			}
		...
		public class When_mapping_from_a_list_of_object_to_generic_dictionary : SpecBase
		{
			...
			protected override void Establish_context()
			{
				MicroMapper.MicroMapper.CreateMap<FooDto, FooObject>();
				MicroMapper.MicroMapper.CreateMap<DestinationValuePair, KeyValuePair<string, string>>()
			...
			protected override void Because_of()
			{
				...
				_result = MicroMapper.MicroMapper.Map<FooDto, FooObject>(source);
			}
