...
namespace AutoMicroMapper.MicroMapper.UnitTests
{
	...
	{
		public class When_mapping_derived_classes_in_arrays : SpecBase
		{
			...
			protected override void Establish_context()
			{
				...
				_result = (DtoObject[]) MicroMapper.MicroMapper.Map(model, typeof (ModelObject[]), typeof (DtoObject[]));
			}
		...
		public class When_mapping_derived_classes : SpecBase
		{
			private DtoObject _result;
		...
		public class When_mapping_derived_classes_from_intefaces_to_abstract : SpecBase
		{
			private DtoObject[] _result;
			...
			protected override void Establish_context()
			{
				...
				MicroMapper.MicroMapper.CreateMap<IModelObject, DtoObject>()
					.Include<ModelSubObject, DtoSubObject>();

				MicroMapper.MicroMapper.CreateMap<ModelSubObject, DtoSubObject>();

				_result = (DtoObject[]) MicroMapper.MicroMapper.Map(model, typeof (IModelObject[]), typeof (DtoObject[]));
			}
		...
		public class When_mapping_derived_classes_as_property_of_top_object : SpecBase
		{
			...
			protected override void Establish_context()
			{
				MicroMapper.MicroMapper.CreateMap<Model, DtoModel>();
			...
			public void Should_map_object_to_sub_object()
			{
				...
				_result = MicroMapper.MicroMapper.Map<Model, DtoModel>(model);
		...
		public class When_mapping_dto_with_only_properties : SpecBase
		{
        ...
        public class When_mapping_dto_with_only_fields : SpecBase
        {
            private ModelDto _result;
        ...
        public class When_mapping_dto_with_fields_and_properties : SpecBase
        {
            private ModelDto _result;
		...
		public class When_ignoring_a_dto_property_during_configuration : SpecBase
		{
			...
			{
				var destination = MicroMapper.MicroMapper.Map<Source, Destination>(_source);
			...
			protected override void Establish_context()
			{
				...
				_allTypeMaps = MicroMapper.MicroMapper.GetAllTypeMaps();
			}
		}

		public class When_mapping_dto_with_get_methods : SpecBase
		{
			private ModelDto _result;
		...
		public class When_mapping_a_dto_with_names_matching_properties : SpecBase
		{
			private ModelDto _result;
		...
		public class When_mapping_with_a_dto_subtype : SpecBase
		{
			private ModelDto _result;
		...
		public class When_mapping_a_dto_with_a_set_only_property_and_a_get_method : SpecBase
		{
			private ModelDto _result;
		...
		public class When_mapping_using_a_custom_member_mappings : SpecBase
		{
			private ModelDto _result;
        ...
        public class When_mapping_using_custom_member_mappings_without_generics : SpecBase
        {
            ...
            protected override void Establish_context()
            {
                ...
                _result = MicroMapper.MicroMapper.Map<Order, OrderDTO>(order);
            }
		...
		public class When_mapping_a_collection_to_a_more_type_specific_collection : NonValidatingSpecBase
		{
			...
			protected override void Establish_context()
			{
				MicroMapper.MicroMapper.CreateMap<Model, ModelDto>();
				MicroMapper.MicroMapper.CreateMap<Item, ItemDto>();
				MicroMapper.MicroMapper.CreateMap<SubItem, SubItemDto>();
				...
				_result = MicroMapper.MicroMapper.Map<Model, ModelDto>(model);
			}
        ...
        public class When_mapping_to_a_self_referential_object : SpecBase
        {
            ...
            protected override void Establish_context()
            {
                MicroMapper.MicroMapper.CreateMap<Category, CategoryDto>();
            }
            ...
            protected override void Because_of()
            {
                ...
                _result = MicroMapper.MicroMapper.Map<Category, CategoryDto>(category);
            }
		...
		public class When_mapping_to_types_in_a_non_generic_manner : SpecBase
		{
			private Destination _result;
			...
			protected override void Establish_context()
			{
				MicroMapper.MicroMapper.CreateMap(typeof (Source), typeof (Destination));
			}
		...
		public class When_matching_source_and_destination_members_with_underscored_members : SpecBase
		{
			...
			protected override void Because_of()
			{
				_destination = MicroMapper.MicroMapper.Map<Source, Destination>(new Source {some_source = new SubSource {value = 8}});
			}
		...
		public class When_source_members_contain_prefixes : SpecBase
		{
			private Destination _destination;
			...
			protected override void Because_of()
			{
				_destination = MicroMapper.MicroMapper.Map<Source, Destination>(new Source {FooValue = 5});
			}
		...
		public class When_source_members_contain_postfixes_and_prefixes : SpecBase
		{
			private Destination _destination;
			...
			protected override void Because_of()
			{
				_destination = MicroMapper.MicroMapper.Map<Source, Destination>(new Source { FooValueBar = 5 });
			}
		...
		public class When_source_member_names_match_with_underscores : SpecBase
		{
			private Destination _destination;
			...
			{
				MicroMapper.MicroMapper.CreateMap<Source, Destination>();
				_destination = MicroMapper.MicroMapper.Map<Source, Destination>(new Source {I_amaCraAZZEE____Name = 5});
			}
		...
		public class When_recognizing_explicit_member_aliases : SpecBase
		{
			private Destination _destination;
			...
			protected override void Because_of()
			{
				_destination = MicroMapper.MicroMapper.Map<Source, Destination>(new Source {Foo = 5});
			}
        ...
        public class When_destination_members_contain_prefixes : SpecBase
        {
            private Destination _destination;
            ...
            protected override void Because_of()
            {
                _destination = MicroMapper.MicroMapper.Map<Source, Destination>(new Source { Value = 5, Value2 = 10 });
            }
...
#endif
    public class When_destination_type_has_private_members : SpecBase
	{
		...
		protected override void Because_of()
		{
			_destination = MicroMapper.MicroMapper.Map<Source, Destination>(new Source {Value = 5});
		}
